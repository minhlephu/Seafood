    ...
    <div className="relative">
      <input
        ...
        className={classNames(
          "w-full px-6 py-4 text-sm font-medium border rounded-xl placeholder:text-text4 border-neutral-300 dark:placeholder:text-text2 dark:text-white bg-transparent",
          error.length > 0
